...
\todo{Introduce the following subsections.}
...
\todo{X is a property before. Now it is a variable. I would recommend using lowercase x for variable names, or other letter.}
...
\todo{Usar listings nos exemplos seguintes, como aqui.}
\begin{lstlisting}
...
\todo{you need a sentence introducing the grammar. You should also highlight the need for a few productions, maybe relating with the high-level concepts.}
