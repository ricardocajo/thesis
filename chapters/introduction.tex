...
\chris{See below note about adjective and references.}
...
While simulation-based tests are a promising approach for automation, there is still distrust in the precision and validity of the results. As a result, simulation-based autonomous testing is barely used due to reliability and factors like cost and complexity.
\chris{\enquote{barely used} is a strong claim (\enquote{rarely} is a better adjective) Add a citation (e.g., our ICST '20 and '21 papers on testing) to provide some evidence.}
...
\chris{Throughout the document, you should \enquote{I} rather than {we}. This is \emph{your} dissertation!}
...
\chris{temporal and positional properties are used here before they are ever defined.
Either define them or use simpler language to explain your objectives at this point (and use the proper terms with a full explanation later in the document).}
...
\chris{It would be nice if you stated the design goals of your DSL.}
...
\chris{rather than saying that the property compiles to a Python file, more explicitly state that your toolchain compiles the DSL program/spec. to  executable Python code.}
