...
\todo{Dividir o próximo parágrafo em 3 frases independentes. Assim é impossível de a ler.}
...
\todo{Não percebi a introdução aqui de variantes, visto que o parágrafo seguinte não usa esse termo.}
