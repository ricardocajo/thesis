...
Some challenges in implementing such mechanisms are mentioned in the cited paper~\cite{stadler2022towards}. \todo{Paper cited where? This paper needs proper introduction and relevance explained. What are the challenges?}
