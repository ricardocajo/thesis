...
\af{Acho que ficava bem aqui referir a conclusão do paper It takes a village, onde dizes que um conjunto de pacotes é usado em quase todos os projectos.}
...
\af{Não concordo com as subsecções. Runtime Monitoring of invariants e invariants não é a mesma coisa? Não são comparáveis para estarem ao mesmo nível no documento. Deviam ser coisas dijuntas.}
...
\af{Devia ser uma secção e não subsecção}
