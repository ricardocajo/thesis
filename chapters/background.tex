...
\chris{There are other means of communication in ROS, too!
I.e., services, actions, and parameters.
The previous sentence suggests that there isn't.
Instead, you might want to say that ROS nodes predominantly use topics to communicate via a publish-subscribe architecture.}
...
\chris{Add a citation to, e.g., the ROS Industrial website to give some evidence for this claim.}
